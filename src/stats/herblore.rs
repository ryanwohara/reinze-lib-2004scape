...
impl Skill for Herblore {
    ...
    fn details(&self) -> Details {
        let details = match self {
            ...
            // Potions
            Self::AttackPotion => ("Attack", "Guam_Leaf", "Eye_of_Newt", 3, 25.0),
            Self::Antipoison => ("Anti_Poison", "Marrentill", "Ground_Unicorn_Horn", 5, 38.0),
            Self::StrengthPotion => ("Strength", "Tarromin", "Limpwurt_Root", 12, 50.0),
            Self::RestorePotion => ("Restore", "Harralander", "Red_Spiders'_Egg", 22, 62.5),
            Self::DefencePotion => ("Defense", "Ranarr_Weed", "White_Berries", 30, 75.0),
            Self::AgilityPotion => ("Agility", "Toadflax", "Toad's_Legs", 34, 80.0),
            Self::PrayerPotion => ("Restore_Prayer", "Ranarr_Weed", "Snape_Grass", 38, 87.5),
            Self::SuperAttack => ("Super_Attack", "Irit_Leaf", "Eye_of_Newt", 45, 100.0),
            Self::SuperAntipoison => (
                "Super_Anti_Poison",
                "Irit_Leaf",
                "Ground_Unicorn_Horn",
            ...
            Self::FishingPotion => ("Fishing", "Avantoe", "Snape_Grass", 50, 113.0),
            Self::SuperStrength => ("Super_Strength", "Kwuarm", "Limpwurt_Root", 55, 125.0),
            Self::WeaponPoison => (
                "Weapon_Poison",
                "Kwuarm",
                "Ground_Blue_Dragon_Scale",
                60,
                137.5,
            ),
            Self::SuperRestore => ("Super_Restore", "Snapdragon", "Red_Spiders'_Egg", 63, 142.0),
            Self::SuperDefence => ("Super_Defense", "Cadantine", "White_Berries", 66, 150.0),
            Self::AntifirePotion => (
                "Anti-FireBreath",
                "Lantadyme",
                "Ground_Blue_Dragon_Scale",
            ...
            Self::RangingPotion => ("Ranging", "Dwarf_Weed", "Wine_of_Zamorak", 72, 162.5),
            Self::ZamorakBrew => ("Potion_of_Zamorak", "Torstol", "Janger_Berries", 78, 175.0),
        };
